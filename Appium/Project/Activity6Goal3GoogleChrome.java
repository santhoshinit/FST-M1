...
public class Activity6Goal3GoogleChrome {
	...
	WebDriverWait wait;
	   ...
	   //AndroidDriver driver1 = new AndroidDriver();
	    ...
	    public String testcredentials(String uname,String password) {
		 ...
		 wait.until(ExpectedConditions.elementToBeClickable(MobileBy.AndroidUIAutomator("textContains(\"Popups\")"))).click();
		
		 wait.until(ExpectedConditions.elementToBeClickable(MobileBy.AndroidUIAutomator("textContains(\"Sign In\")"))).click();
